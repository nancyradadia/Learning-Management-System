    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('course_id', models.CharField(max_length=50)),
                ('course_enrollment_year', models.DateField(default=datetime.datetime(2021, 3, 31, 8, 27, 37, 153026, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('course_enrollment_year', models.DateField(default=datetime.datetime(2021, 3, 31, 8, 27, 37, 155021, tzinfo=utc))),
