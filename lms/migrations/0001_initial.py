# Generated by Django 3.1.7 on 2021-03-25 10:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_year', models.DateField(default=datetime.datetime(2021, 3, 25, 10, 57, 59, 890467, tzinfo=utc))),
                ('course_id', models.CharField(max_length=50)),
                ('faculty_id', models.CharField(max_length=50)),
                ('description', models.CharField(max_length=200)),
                ('PDF', models.FileField(upload_to='static/', validators=[lms.models.Faculty_Assignment.validate_PDF])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('course_id', models.CharField(max_length=50)),
                ('course_enrollment_year', models.DateField(default=datetime.datetime(2021, 3, 25, 10, 57, 59, 889449, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('course_enrollment_year', models.DateField(default=datetime.datetime(2021, 3, 25, 10, 57, 59, 890467, tzinfo=utc))),
