    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_year', models.DateField(default=datetime.datetime(2021, 3, 26, 13, 41, 39, 608318, tzinfo=utc))),
                ('course_id', models.CharField(max_length=50)),
                ('faculty_id', models.CharField(max_length=50)),
                ('description', models.CharField(max_length=200)),
                ('PDF', models.FileField(upload_to='static/images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('course_id', models.CharField(max_length=50)),
                ('course_enrollment_year', models.DateField(default=datetime.datetime(2021, 3, 26, 13, 41, 39, 606323, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('course_enrollment_year', models.DateField(default=datetime.datetime(2021, 3, 26, 13, 41, 39, 607320, tzinfo=utc))),
